...
public class WaitNotifyIndexer {
	...
	private static class Downloader implements Runnable {
		...
		public void run() {
			System.out.println("I am downloader in block");
			try {
				synchronized (weblink) {
					System.out.println("I am downloader in sync block");
	...
	private static class Indexer implements Runnable {
		...
		public void run() {	
			System.out.println("I am inderxer in block");
			
			// Without synchronized block, wait/notify calls will throw IllegalMonitorStateException 
			synchronized (weblink) {
				System.out.println("I am inderxer in Sync block");
